...
_C.DATASET.ADD_ADJ = True
_C.DATASET.TRAIN_ADJ_PATH = ''
_C.DATASET.VAL_ADJ_PATH = ''
_C.DATASET.USE_3D_COORDS = False
_C.DATASET.USE_MENTIONED_LBL = False
_C.DATASET.USE_TURN_LBL = False
