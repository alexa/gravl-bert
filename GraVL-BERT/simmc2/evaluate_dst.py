...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_path_target", help="path for target (.json)", default="/Users/danfengg/Documents/labels/simmc2_dials_dstc10_devtest.json")
    parser.add_argument(
        "--input_path_predicted", help="path for model prediction output (.json)", default="/Users/danfengg/Documents/VL-BERT/simmc2/results/devtest/results_dstc_34_2.json"
    )
    parser.add_argument(
        "--output_path_report", help="path for saving evaluation summary (.json)", default="/Users/danfengg/Documents/VL-BERT/simmc2/results/devtest/eval_dstc_34_2.json"
    )
