...
class ResNetVLBERT_mlm(Module):
    ...
    def forward(self,
        ...
        # prepare text
        text_input_ids, text_token_type_ids, text_tags, text_mask = self.prepare_text_from_qa(text)
        ...
        mlm_logits_padded = mlm_logits.new_zeros((*label.shape, mlm_logits.shape[-1])).fill_(-10000.0)
